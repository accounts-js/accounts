...
export interface DBInterface {
  ...
  updateSession(sessionId: string, ip: string, userAgent: string, impersonatedUserId: string = null) : Promise<void>,
  updateSessionImpersonatedUserId(sessionId: string, impersonatedUserId: string): Promise<void>,
  invalidateSession(sessionId: string): Promise<void>,
  invalidateAllSessions(userId: string): Promise<void>,
  findSessionById(sessionId: string) : Promise<?SessionType>,
  findActiveSessionByUserId(userId: string) : Promise<?SessionType>,
