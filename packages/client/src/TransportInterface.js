...
export interface TransportInterface {
  ...
  sendResetPasswordEmail(email: string, args): Promise<void>,
  sendVerificationEmail(email: string, args): Promise<void>,
  impersonate(token: string, username: string ,args),
}
