...
function Home() {
  ...
  return (
    ...
    >
      ...
      <section className={clsx(styles.section, styles.example)}>
        <h2 className={styles.homeTitle}>
          <span>Try the examples</span>
        </h2>

        <div className="container">
          <div className={clsx('row', styles.exampleRow)}>
            <div className={clsx('col col--3')}>
              <div className={clsx(styles.exampleCard)}>
                <div>
                  <svg className={clsx(styles.exampleCardLogoGraphQL)} viewBox="0 0 400 400">
                ...
                <div>
                  <a
                    className={clsx(styles.exampleCardLink)}
            ...
            <div className={clsx('col col--3')}>
              <div className={clsx(styles.exampleCard)}>
                <div>
                  <svg className={clsx(styles.exampleCardLogoExpress)} viewBox="0 0 128 128">
